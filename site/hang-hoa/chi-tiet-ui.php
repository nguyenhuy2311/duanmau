    ...
    <div class="row">
        <div class="col">
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?= $SITE_URL . '/trang-chinh/index.php' ?>">Trang chủ</a></li>
        ...
        <div class="col-12 col-lg-6 add_to_cart_block">
            <div class="card bg-light mb-3">
                <div class="card-body text-center">
                    ...
                    <!-- Form to add to cart -->
                    <form method="get" action="<?= $SITE_URL . "/cart/add-cart.php?id=" ?>">
                    <input type="hidden" name="id" value="<?= $items['ma_hh'] ?>">
                    ...
                    <div class="product_rassurance">
                        <ul class="list-inline">
                            ...
                            <li class="list-inline-item"><i class="fa fa-phone fa-2x"></i><br />19009909
                            </li>
                        </ul>
                    </div>
